...
} from "./chunk-CLW4KPO2.js";
import {
  tiny_warning_esm_default
} from "./chunk-XF7LHSSL.js";
import "./chunk-Z6ANZSWS.js";
import {
  require_react
} from "./chunk-66GADNPQ.js";
import {
  __commonJS,
  __toESM,
  _global,
...
function useFormikContext() {
  ...
  !!!formik ? import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, "Formik context is undefined, please verify you are calling useFormikContext() as child of a <Formik> component.") : tiny_warning_esm_default(false) : void 0;
  return formik;
}
...
function useFormik(_ref) {
  ...
  if (import_process.default.env.NODE_ENV !== "production") {
    (0, import_react.useEffect)(function() {
      !(typeof isInitialValid === "undefined") ? import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, "isInitialValid has been deprecated and will be removed in future versions of Formik. Please use initialErrors or validateOnMount instead.") : tiny_warning_esm_default(false) : void 0;
    }, []);
  }
  (0, import_react.useEffect)(function() {
  ...
  var executeChange = (0, import_react.useCallback)(function(eventOrTextValue, maybePath) {
    ...
    if (!isString(eventOrTextValue)) {
      ...
      if (!field && import_process.default.env.NODE_ENV !== "production") {
  ...
  var handleSubmit = useEventCallback(function(e) {
    ...
    if (import_process.default.env.NODE_ENV !== "production" && typeof document !== "undefined") {
      var activeElement = getActiveElement();
      if (activeElement !== null && activeElement instanceof HTMLButtonElement) {
        !(activeElement.attributes && activeElement.attributes.getNamedItem("type")) ? import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, 'You submitted a Formik form using a button with an unspecified `type` attribute.  Most browsers default button elements to `type="submit"`. If this is not a submit button, please add `type="button"`.') : tiny_warning_esm_default(false) : void 0;
      }
    }
...
function Formik(props) {
  ...
  if (import_process.default.env.NODE_ENV !== "production") {
    (0, import_react.useEffect)(function() {
      !!props.render ? import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, "<Formik render> has been deprecated and will be removed in future versions of Formik. Please use a child callback function instead. To get rid of this warning, replace <Formik render={(props) => ...} /> with <Formik>{(props) => ...}</Formik>") : tiny_warning_esm_default(false) : void 0;
    }, []);
  }
...
function useField(propsOrFieldName) {
  ...
  if (import_process.default.env.NODE_ENV !== "production") {
    !formik ? import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, "useField() / <Field /> must be used underneath a <Formik> component or withFormik() higher order component") : tiny_warning_esm_default(false) : void 0;
  }
  !fieldName ? import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, "Invalid field name. Either pass `useField` a string or an object containing a `name` key.") : tiny_warning_esm_default(false) : void 0;
...
function Field(_ref) {
  ...
  if (import_process.default.env.NODE_ENV !== "production") {
    (0, import_react.useEffect)(function() {
      !!render ? import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, '<Field render> has been deprecated and will be removed in future versions of Formik. Please use a child callback function instead. To get rid of this warning, replace <Field name="' + name + '" render={({field, form}) => ...} /> with <Field name="' + name + '">{({field, form, meta}) => ...}</Field>') : tiny_warning_esm_default(false) : void 0;
      !!(is && children && isFunction2(children)) ? import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, "You should not use <Field as> and <Field children> as a function in the same <Field> component; <Field as> will be ignored.") : tiny_warning_esm_default(false) : void 0;
      !!(component && children && isFunction2(children)) ? import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, "You should not use <Field component> and <Field children> as a function in the same <Field> component; <Field component> will be ignored.") : tiny_warning_esm_default(false) : void 0;
      !!(render && children && !isEmptyChildren(children)) ? import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, "You should not use <Field render> and <Field children> in the same <Field> component; <Field children> will be ignored") : tiny_warning_esm_default(false) : void 0;
    }, []);
  }
...
function connect(Comp) {
  var C = function C2(props) {
    return (0, import_react.createElement)(FormikConsumer, null, function(formik) {
      !!!formik ? import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, "Formik context is undefined, please verify you are rendering <Form>, <Field>, <FastField>, <FieldArray>, or your custom context-using component as a child of a <Formik> component. Component name: " + Comp.name) : tiny_warning_esm_default(false) : void 0;
...
var FastFieldInner = function(_React$Component) {
  ...
  function FastFieldInner2(props) {
    ...
    !!render ? import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, "<FastField render> has been deprecated. Please use a child callback function instead: <FastField name={" + name + "}>{props => ...}</FastField> instead.") : tiny_warning_esm_default(false) : void 0;
    !!(component && render) ? import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, "You should not use <FastField component> and <FastField render> in the same <FastField> component; <FastField component> will be ignored") : tiny_warning_esm_default(false) : void 0;
    !!(is && children && isFunction2(children)) ? import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, "You should not use <FastField as> and <FastField children> as a function in the same <FastField> component; <FastField as> will be ignored.") : tiny_warning_esm_default(false) : void 0;
    !!(component && children && isFunction2(children)) ? import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, "You should not use <FastField component> and <FastField children> as a function in the same <FastField> component; <FastField component> will be ignored.") : tiny_warning_esm_default(false) : void 0;
    !!(render && children && !isEmptyChildren(children)) ? import_process.default.env.NODE_ENV !== "production" ? tiny_warning_esm_default(false, "You should not use <FastField render> and <FastField children> in the same <FastField> component; <FastField children> will be ignored") : tiny_warning_esm_default(false) : void 0;
    return _this;
  }
