...
} from "./chunk-4MDF5JZN.js";
import {
  require_react_dom
} from "./chunk-42QAEIE2.js";
import {
...
init_shim();
var import_shim28 = __toESM(require_shim());
...
function createReduxContextHook(context = ReactReduxContext) {
  return function useReduxContext2() {
    ...
    if (import_process.default.env.NODE_ENV !== "production" && !contextValue) {
...
function connect(mapStateToProps, mapDispatchToProps, mergeProps, {
  ...
  const wrapWithConnect = (WrappedComponent) => {
    if (import_process.default.env.NODE_ENV !== "production" && !(0, import_react_is.isValidElementType)(WrappedComponent)) {
    ...
    function ConnectFunction(props) {
      ...
      if (import_process.default.env.NODE_ENV !== "production" && !didStoreComeFromProps && !didStoreComeFromContext) {
...
initializeConnect(import_shim28.useSyncExternalStore);
